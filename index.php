...
<body>
	...
	<div class="body">
		<div>
			<ul>
	  			<li><a class="home" href="index.php"><button class="bbt" disabled="disabled"><i class="fas fa-house-user"></button></i>  Trang chủ</a></li>
			...
			<div class="main">
				<h1><a href="game_info.php">Trò chơi</a></h1>
				<div class="row">
                    <?php
                    if (mysqli_num_rows($result) > 0) {
	                	...
	                	<div class="game"> 
	                	<a href="./all_game.php?gameid='.$row['gameid'].'">
	                		<img src="'.$row['image_url'].'">
	                	</a>	
			                <div class="game-information">
		                        <span class="game-title"><a href="./all_game.php?gameid='.$row['gameid'].'">'.$row['gamename'].'</a></span>
		                        <span class="game-author"><a href="./all_game.php?gameid='.$row['gameid'].'">'.$row['name_author'].'</a></span>
		                        ...
		                        <span class="money"><a href="./all_game.php?gameid='.$row['gameid'].'">'.$row['game_money'].'</a></span>
		                    </div>
	                	</div>
	            	</div>';
                        }
				...
				<h1><a href="movie_info.php">Phim</a></h1>
				<div class="row">
                    <?php
                    if (mysqli_num_rows($resultm) > 0) {
                        while ($row = $resultm->fetch_assoc()) {
                            echo '<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
	                	<div class="game">
		                    <a href="./all_movie.php?movie_id='.$row['movie_id'].'">
		                    	<img src="'.$row['image_url'].'">
		                    </a>
		                    <div class="game-information">
		                        <span class="game-title"><a href="./all_movie.php?movie_id='.$row['movie_id'].'">'.$row['movie_name'].'</a></span>
		                        ...
		                        <span class="money"><a href="./all_movie.php?movie_id='.$row['movie_id'].'">'.$row['movie_money'].'</a></span>
		                    </div>
	                	</div>
	            	</div>';
                        }
